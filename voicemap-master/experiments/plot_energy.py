...
if __name__ == '__main__':
	...
	# n_seconds = 5
	# bin_size = 0.01
	# train = LibriSpeechDataset(training_set, n_seconds, pad=True, stochastic= False)
	...
	energy_bins_1 = np.load('dev_energy_bins_1.npz.npy')
	energy_bins_2 = np.load('dev_energy_bins_2.npz.npy')
	energy_bins_3 = np.load('dev_energy_bins_3.npz.npy')
	energy_bins_4 = np.load('dev_energy_bins_4.npz.npy')
	energy_bins_5 = np.load('dev_energy_bins_5.npz.npy')
